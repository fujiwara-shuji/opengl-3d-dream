...
private:
    ...
    // Debug mode: disable visibility check for easier selection
...
public:
    ...
    // Debug mode control
    void setDisableVisibilityCheck(bool disable) { disableVisibilityCheck = disable; }
    bool getDisableVisibilityCheck() const { return disableVisibilityCheck; }
